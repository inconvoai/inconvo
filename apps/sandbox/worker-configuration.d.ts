/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b5758087996413955d3975f56f62b935)
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		CUSTOMER_CONVERSATION_DATA: R2Bucket;
		CUSTOMER_DATASETS: R2Bucket;
		DATASETS_BUCKET: "customer-datasets-dev";
		CONVERSATION_DATA_BUCKET: "customer-conversation-data-dev";
		INTERNAL_API_KEY: string;
		SKIP_BUCKET_MOUNT: string;
	...
	interface Env {
		...
		CUSTOMER_CONVERSATION_DATA: R2Bucket;
		CUSTOMER_DATASETS: R2Bucket;
		DATASETS_BUCKET: "customer-datasets-dev" | "customer-datasets";
		CONVERSATION_DATA_BUCKET: "customer-conversation-data-dev" | "customer-conversation-data";
		Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATASETS_BUCKET" | "CONVERSATION_DATA_BUCKET" | "INTERNAL_API_KEY" | "SKIP_BUCKET_MOUNT">> {}
}
