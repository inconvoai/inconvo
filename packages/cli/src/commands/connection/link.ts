...
export const connectionLinkCommand = new Command("link")
  .description("Link a shared connection from another agent")
  .requiredOption("--agent <agentId>", "Target agent id")
  .option("--connection <connectionId>", "Connection id to link")
