...
INCONVO_BIGQUERY_CREDENTIALS_JSON={"type":"service_account",...} # or INCONVO_BIGQUERY_CREDENTIALS_BASE64
INCONVO_BIGQUERY_KEYFILE=/path/to/key.json
INCONVO_BIGQUERY_MAX_BYTES_BILLED=1000000000 # optional, must be an integer greater than 0
```

If multiple BigQuery credential sources are set, precedence is:
